...
globals()['RepNCSPELAN4'] = RepNCSPELAN4
...
class YOLOv10DetectionModel(DetectionModel):
    def init_criterion(self):
        ...
        return v10DetectLoss(self,device=device,learnable_weights=True)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in (C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB,MANet):
            ...
            c1 = ch[f]
            args = [c1, *args[1:]]
        elif m is WaveletAttentionModule:
            c1 = ch[f]
            args = [c1, *args[1:]]
        elif m is EfficientChannelAttention:
            c2 = args[0]
            c1 = ch[f]
            if c2 != nc:
                c2 = make_divisible(min(c2, max_channels) * width, 8)
